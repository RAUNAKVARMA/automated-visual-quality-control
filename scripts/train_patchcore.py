...
def main() -> None:
    ...
    parser.add_argument("--config", type=Path, default=ROOT / "configs" / "patchcore_config.yaml")
    ...
    out_dir = Path(trainer_cfg.get("default_root_dir", "outputs/models/patchcore"))
    ...
    report_path = paths.reports_dir / f"train_patchcore_{cfg['data']['category']}.json"
